...
class AudioPlayerInline extends StatefulWidget {
  ...
  @override
  _AudioPlayerInlineState createState() => _AudioPlayerInlineState();
}
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _isActive
              ? ControlButtons(_player, widget.onPlay)
              : IconButton(
...
class ControlButtons extends StatelessWidget {
  ...
  const ControlButtons(this.player, [this.onPlay, Key? key]) : super(key: key);
