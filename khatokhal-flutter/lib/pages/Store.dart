...
class HorizontalListSliver extends StatelessWidget {
  ...
  HorizontalListSliver({required this.row});
                ...
                slivers: [
                  (isSlide && row.slides?.length == 1)
                      ...
                      : SliverFixedExtentList(
                          itemExtent: _width,
                          delegate: SliverChildBuilderDelegate(
                            (context, index) => row.itemType == RowType.Slide
                                ? StoreSlideItem(
                                    aspectRatio: 2,
                                    width: _width,
                                    key: UniqueKey(),
                            ...
                            childCount: row.itemType == RowType.Slide
                                ? row.slides!.length
                                : row.books!.length,
                          ),
                        ),
...
class StoreBookItem extends StatelessWidget {
  ...
  StoreBookItem({Key? key, required this.book}) : super(key: key);
